Polymer({
  ...
  isEmptyStatsResults: function () {
    return (!this.stats.hasOwnProperty('id') || this.stats.hasOwnProperty(
        'id') && this.stats.id.count == 0) && (!this.stats.hasOwnProperty(
        'thomson_citation_count_i') || this.stats.hasOwnProperty(
        'thomson_citation_count_i') && (this.stats.thomson_citation_count_i == null || this.stats.thomson_citation_count_i.count == 0 && this.stats.thomson_citation_count_i.sum == 0)) && (!this.stats.hasOwnProperty(
        'scopus_citation_count_i') || this.stats.hasOwnProperty(
